...
public class Withdrawal extends Transaction {
	...
	@Override
	public void execute() {
		boolean cashDispensed = false; // cash was not dispensed
			...
			if (amount != CANCELED) {
				...
				if (amount <= availableBalance) {
					...
					if (cashDispenser.isSufficientCashAvailable(amount)) {
						...
						screen.displayMessageLine(
								"\nInsufficient cash avaialbe in the ATM." + "\n\nPlease choose a smaller amount.");
					}
	...
	// display a menu of withdrawal amount and the option to cancel;
